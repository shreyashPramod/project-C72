...
<KeyboardAvoidingView style={styles.container} be="padding" enabled>
...
onChangeText={text =>this.setState({WriteYourStory: text})}
placeholderTextColor='black'
value={this.state.storyText} style={styles.storyText} multiline={true}/>
